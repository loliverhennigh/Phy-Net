...
def generate_tfrecords(run_num, num_samples, seq_length, dir_name):
  ...
  filename = '../data/tfrecords/' + dir_name + '/balls_run_num_' + str(run_num) + '_num_samples_' + str(num_samples) + '_seq_length_' + str(seq_length) + '_friction_' + str(FLAGS.friction) + '_num_balls_' + str(FLAGS.num_balls) + '.tfrecords'
