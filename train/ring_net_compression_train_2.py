...
load_dir = FLAGS.train_dir + FLAGS.model + FLAGS.system + "_compression" + FLAGS.compression_loss + "_compression_vae_loss_" + str(FLAGS.compression_vae_loss) + "_sample_compression_" + str(FLAGS.sample_compression) + "_lstm_size_" + str(FLAGS.lstm_size)
train_dir = FLAGS.train_dir + FLAGS.model + FLAGS.system + "_compression_2" + FLAGS.compression_loss + "_compression_vae_loss_" + str(FLAGS.compression_vae_loss) + "_sample_compression_" + str(FLAGS.sample_compression) + "_lstm_size_" + str(FLAGS.lstm_size)
...
elif FLAGS.model in ("lstm_32x32x3", "lstm_32x32x10", "lstm_84x84x3", "lstm_84x84x4", "lstm_32x32x3_64", "lstm_32x32x3_128", "lstm_32x32x3_256", "lstm_32x32x512"):
  #CURRICULUM_STEPS = [200000, 250000, 250000, 300000, 500000]
  CURRICULUM_STEPS = [600000]
  #CURRICULUM_STEPS = [8, 8, 8]
  #CURRICULUM_STEPS = [10, 10, 10, 10, 10]
  CURRICULUM_SEQ = [15]
  CURRICULUM_BATCH_SIZE = [32]
  CURRICULUM_LEARNING_RATE = [5e-6]
  CURRICULUM_TRAIN_PIECE = ["compression"]
