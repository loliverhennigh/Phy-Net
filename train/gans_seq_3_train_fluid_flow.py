...
# save file name
RESTORE_DIR = '../checkpoints/' + model + '_' + system + '_gan_' + 'seq_length_1'
SAVE_DIR = '../checkpoints/' + model + '_' + system + '_gan_' + 'seq_length_3'
...
def train():
  ...
  with tf.Graph().as_default():
    ...
    error_reconstruction = tf.nn.l2_loss(flow[:,5:8,:,:,:] - x_2_o)
