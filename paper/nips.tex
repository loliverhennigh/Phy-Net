...
There has also been an increasing body of work applying neural networks other physics related problems. In Mills ect \cite{mills2017deep} and Giuseppe ect \cite{caleo2017solving}, neural networks are used to approximate solutions to the schodiener equation. 

Reduced order Modeling (ROM) is closely realated the this work. 
