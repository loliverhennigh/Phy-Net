...
NUM_NETWORKS = 3
NETWORKS = ["../checkpoints/balls_3_paper_lstm_32x32x3balls_compressionkl_compression_vae_loss_False_sample_compression_False_lstm_size_64", "../checkpoints/balls_3_paper_lstm_32x32x3balls_compressionkl_compression_vae_loss_False_sample_compression_False_lstm_size_128", "../checkpoints/balls_3_paper_lstm_32x32x3balls_compressionkl_compression_vae_loss_False_sample_compression_False_lstm_size_256"]
...
def evaluate(i):
  ...
  with tf.Graph().as_default():
    ...
    plt.savefig('../../Compressing-Dynamical-Systems-Paper/figures/bouncing_balls/bouncing_balls_error_3.png')
